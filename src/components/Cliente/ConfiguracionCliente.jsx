...
function createDataInformacion(
    ...
    return { nombre, apellido, tipoUsuario, colonia, ciudad, estado, correo, numero, codigoPostal, ID, servicios }
}

const rowsInformacion = [
    createDataInformacion( 'Juan', 'Alonso', 'Dueño de mascota', 'Gonzalo Guerrero', 'Playa del Carmen', 'Quintana Roo', 'Juan910240@gmail.com', '+52 984 391 2182', 77710, 120314, 'Adiestramiento' ),
]
            ...
            <Grid size={{xs: 12,sm: 12,md:12}}>
                {rowsInformacion.map((rowInformacion) =>(
                    ...
                    >
                        ...
                        <Typography sx={{ fontSize: { xs: '14px', md: '20px' }, flex: 1 }}>{rowInformacion.tipoUsuario}</Typography>
                ...
                <Grid size={{xs: 12,sm: 12,md:12}}>
                    <Box
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'row'}}>
                            ...
                            <Typography sx={{ flex: 1, fontSize: '18px', color: '#848484' }}>Apellidos</Typography>
                            <Typography sx={{ flex: 1, fontSize: '18px', color: '#848484' }}>Servicios</Typography>
                        </Box>
                        {rowsInformacion.map((rowInformacion) => (
                            <Box sx={{ display: 'flex', flexDirection: 'row'}}>
                                ...
                                <Typography sx={{ flex:1, fontSize: '18px', fontWeight: 'bold' }}>{rowInformacion.servicios}</Typography>
                            </Box>
                        ))}

                        <Box sx={{ display: 'flex', flexDirection: 'row'}}>
                            <Typography sx={{ flex: 1, fontSize: '18px', color: '#848484' }}>Correo electrónico</Typography>
                            <Typography sx={{ flex: 2, fontSize: '18px', color: '#848484' }}>Número telefónico</Typography>
                        </Box>
                        {rowsInformacion.map((rowInformacion) => (
                            <Box sx={{ display: 'flex', flexDirection: 'row'}}>
                ...
                <Box
                    ...
                    >
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'row'}}>
                            <Typography sx={{ flex: 1, fontSize: '18px', color: '#848484' }}>Colonia</Typography>
                            <Typography sx={{ flex: 1, fontSize: '18px', color: '#848484' }}>Ciudad</Typography>
                            <Typography sx={{ flex: 1, fontSize: '18px', color: '#848484' }}>Estado</Typography>
                        </Box>
                        {rowsInformacion.map((rowInformacion) => (
                            <Box sx={{ display: 'flex', flexDirection: 'row'}}>
                                <Typography sx={{ flex:1, fontSize: '18px', fontWeight: 'bold' }}>{rowInformacion.colonia}</Typography>
                                <Typography sx={{ flex:1, fontSize: '18px', fontWeight: 'bold' }}>{rowInformacion.ciudad}</Typography>
                                <Typography sx={{ flex:1, fontSize: '18px', fontWeight: 'bold' }}>{rowInformacion.estado}</Typography>
                            </Box>
                        ))}
